...
#elif defined(_VARIANT_SPACE_BOARD_)
	#include <PC8574_IO.h>
	inline static void initSS() {exp_pin_out(PIN_SPI_SS_ETHERNET_LIB,HIGH);}
	inline static void setSS() 	{exp_pin_out(PIN_SPI_SS_ETHERNET_LIB,LOW);}
	inline static void resetSS(){exp_pin_out(PIN_SPI_SS_ETHERNET_LIB,HIGH);}	
